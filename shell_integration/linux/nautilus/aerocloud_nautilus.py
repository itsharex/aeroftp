...
# Try Nautilus 4.0 first (GNOME 43+), fallback to 3.0
try:
...
class AeroCloudExtension(GObject.GObject, Nautilus.InfoProvider):
    """Nautilus extension that adds AeroCloud sync status emblems."""
    ...
    def _apply_emblem(self, file: Nautilus.FileInfo, status: str) -> None:
