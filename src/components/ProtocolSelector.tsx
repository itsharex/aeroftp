...
const getProtocols = (t: (key: string, params?: Record<string, string>) => string): ProtocolInfo[] => [
    ...
    // Disabled providers (not tested or temporarily unavailable)
    {
        type: 'drime',
        name: 'Drime Cloud',
...
const PROTOCOLS_FALLBACK: ProtocolInfo[] = [
    ...
    { type: 'filelu', name: 'FileLu', icon: <FileLuLogo size={18} />, description: 'Multi-Protocol Cloud Storage', defaultPort: 443, badge: 'API', color: 'text-violet-500', isCloudStorage: true, tooltip: 'FileLu — API Key auth, 1GB free' },
