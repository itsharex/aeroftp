            ...
            >
                ...
                <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                    <div className="flex items-center gap-2">
                        <svg viewBox="0 0 32 32" width={18} height={18} fill="currentColor" className="text-cyan-500 dark:text-cyan-400">
                            ...
                            <path d="M31.5,12.3c-0.1-0.5-0.6-0.8-1.1-0.8c-1.5,0.2-2.9-0.5-3.6-1.8c-0.7-1.3-0.5-2.9,0.5-4c0.3-0.4,0.3-0.9,0-1.3 c-1.3-1.5-2.9-2.6-4.7-3.3c-0.5-0.2-1,0-1.2,0.4c-0.7,1.4-2.2,2.2-3.8,2.1c-1.5-0.1-2.9-1.1-3.4-2.5C14,0.7,13.5,0.5,13,0.6 C11,1.2,9.2,2.2,7.8,3.6C7.5,4,7.5,4.5,7.8,4.9c1,1.1,1.2,2.7,0.5,4C7.6,10.2,6.2,10.8,4.7,10.7c-0.5,0-0.9,0.3-1.1,0.8 C3.2,12.7,3,14,3,15.2c0,0.5,0.1,1.1,0.2,1.7c0.1,0.5,0.5,0.8,1,0.8c0,0,0.1,0,0.1,0c1.5-0.1,2.9,0.6,3.6,1.9 c0.7,1.3,0.5,2.8-0.4,3.9c-0.3,0.4-0.3,0.9,0.1,1.3c1.3,1.4,2.8,2.4,4.5,3.1c0.5,0.2,1,0,1.3-0.4c0.7-1.3,2.1-2.1,3.6-2.1 c0.1,0,0.1,0,0.2,0c1.5,0.1,2.8,1,3.4,2.4c0.2,0.5,0.7,0.7,1.2,0.6c1.9-0.6,3.7-1.6,5.1-2.9c0.4-0.3,0.4-0.9,0.1-1.3 c-1-1.1-1.2-2.7-0.5-4c0.7-1.3,2.1-2.1,3.6-1.9c0.5,0.1,1-0.2,1.1-0.7c0.3-1.3,0.4-2.7,0.2-4.1C31.8,12.9,31.7,12.5,31.5,12.3 z M22,22c0,1.1-0.9,2-2,2h-8c-1.1,0-2-0.9-2-2v-6c0-1.1,0.9-2,2-2v-1c0-2.8,2.2-5,5-5s5,2.2,5,5v1c1.1,0,2,0.9,2,2V22z"/>
                        </svg>
