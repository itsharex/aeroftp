...
// Antigravity/Claude special - Purple gradient effect
export const AntigravityIcon: React.FC<IconProps> = ({ size = 16, className = '' }) => (
    <svg
        viewBox="0 0 24 24"
        width={size}
        height={size}
    ...
    >
        <defs>
            <linearGradient id="antigravity-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
...
export default { GeminiIcon, OpenAIIcon, AnthropicIcon, AntigravityIcon };
